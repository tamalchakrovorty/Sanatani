...
async function seed() {
  ...
  for (const e of EVENTS) {
    ...
    await pool.query(
      `INSERT INTO events (id, title, cat, venue, start, "end", blurb, "desc", sched, tickets, partners, cover_image, cover_mode, motif, pal_key, pal, cd, pub, posts, notices)
      ...
      [e.id, e.title, e.cat, e.venue, e.start, e.end, e.blurb, JSON.stringify(e.desc), JSON.stringify(e.sched),
       ...
       '', 'art', e.motif, e.palKey, JSON.stringify(pal), e.cd, e.pub, '[]', '[]']
    );
  }
